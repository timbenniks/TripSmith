...
export async function GET() {
  ...
  try {
    ...
    console.error('[admin/shares] admin client error', e);
  ...
  try {
    ...
    console.error('[admin/shares] error', e);
    return NextResponse.json({ error: 'Failed to load shares stats', code: 'UNKNOWN' }, { status: 500 });
  }
}
